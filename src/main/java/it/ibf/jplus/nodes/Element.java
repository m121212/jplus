package it.ibf.jplus.nodes;


import it.ibf.jplus.helper.StringUtil;
import it.ibf.jplus.helper.Validate;
import it.ibf.jplus.parser.Parser;
import it.ibf.jplus.parser.Tag;
import it.ibf.jplus.select.*;
...
public class Element extends Node {
     ...
     * </ul>
     * <p/>
     * See the query syntax documentation in {@link it.ibf.jplus.select.Selector}.
     *
     * @param cssQuery a {@link Selector} CSS-like query
     * @return elements that match the query (empty if none match)
     * @see it.ibf.jplus.select.Selector
     */
