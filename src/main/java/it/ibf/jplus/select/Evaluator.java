package it.ibf.jplus.select;


import it.ibf.jplus.helper.Validate;
import it.ibf.jplus.nodes.Comment;
import it.ibf.jplus.nodes.Document;
import it.ibf.jplus.nodes.DocumentType;
import it.ibf.jplus.nodes.Element;
import it.ibf.jplus.nodes.Node;
import it.ibf.jplus.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<it.ibf.jplus.nodes.Attribute> values = element.attributes().asList();
            for (it.ibf.jplus.nodes.Attribute attribute : values) {
